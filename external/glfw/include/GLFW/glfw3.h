 ...
 *  while raw motion is better for controlling for example a 3D m_camera.  Because
 ...
 *
 *  __Do not use this function__ to implement things like m_camera controls.  GLFW

...
namespace glm
{
	...
	///
	/// @param eye Position of the m_camera
	/// @param center Position where the m_camera is looking at
	/// @param up Normalized up vector, how the m_camera is oriented. Typically (0, 0, 1)
	///
	/// @tparam T A floating-point scalar type
	/// @tparam Q A value from qualifier enum
	///
